            ...
            for k in range(niter):
                ...
                if(np.mod(k, 4) == 0):  # check Lagrangian
                    ...
                    dxchange.write_tiff_stack(
                        u.real,  outdir+'/'+name+'_'+part+'/tmp'+'_'+str(ntheta)+'_'+str(alpha)+'/rect'+str(k)+'/r', overwrite=True)
                    dxchange.write_tiff_stack(
                        psi1.real, outdir+'/'+name+'_'+part+'/tmp'+'_'+str(ntheta)+'_'+str(alpha)+'/psir'+str(k)+'/r',  overwrite=True)
                    np.save(outdir+'/'+name+'_'+part+'/tmp'+'_'+str(ntheta)+'_'+str(alpha)+'/flow'+str(k), flow)                # Updates
